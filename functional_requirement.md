...
11. 프로젝트의 유저가 이슈에 코멘트를 달고, 자신이 단 코멘트를 관리
12. Reporter가 이슈를 등록
13. Triager가 이슈를 특정 유저에게 할당  \- 할당에 추천시스템을 활용할 수 있음
14. Assignee가 이슈를 해결함
15. Tester가 Assginee가 이슈를 제대로 해결했는지 확인함
16. Verifier가 resolved된 이슈를 최종 확인 후 close 함
